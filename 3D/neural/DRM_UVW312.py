...
def main():
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\u312.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\v312.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\w312.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    model_low.load_state_dict(torch.load('model_uvw12.mdl'))
    ...
    for epoch in range(epochs + 1):
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_uvw312.mdl')
