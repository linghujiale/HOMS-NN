...
def main():
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\u211.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\v211.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\w211.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    model_low.load_state_dict(torch.load('model_uvw11.mdl'))
    ...
    C01111 = torch.mean(C2 + C2 * u_x + C1 * v_y + C2 * w_z)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs + 1):
        ...
        loss_r2 = torch.squeeze((C2 - C01111) * v)
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_uvw211.mdl')
