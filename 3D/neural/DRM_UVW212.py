...
def main():
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\u212.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\v212.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\w212.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    C01111 = torch.mean(C3 + C3 * u_y + C3 * v_x)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs + 1):
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_uvw212.mdl')
