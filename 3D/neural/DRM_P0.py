...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\3d\data\P01.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\3d\data\P02.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\3d\data\P03.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze(beta * u_x) + torch.squeeze(beta * v_y) + torch.squeeze(beta * w_z)
    ...
    torch.save(model.state_dict(), 'model_P0.mdl')
