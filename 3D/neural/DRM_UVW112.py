...
def main():
    ...
    data = pd.read_csv(r"data\u112.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"data\v112.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"data\w112.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    torch.save(model.state_dict(), 'model_uvw112.mdl')
