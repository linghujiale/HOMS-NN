...
def main():
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\u223.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\v223.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\w223.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    model_low.load_state_dict(torch.load('model_uvw23.mdl'))
    ...
    C01111 = torch.mean(C3 + C3 * v_z + C3 * w_y)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs + 1):
        ...
        loss_r2 = torch.squeeze((C3 - C01111) * w)
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_uvw223.mdl')
