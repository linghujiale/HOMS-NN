...
def main():
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\u233.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\v233.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    data = pd.read_csv(r"E:\PyCharm\project6\3d\data\w233.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    for epoch in range(epochs + 1):
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_uvw233.mdl')
