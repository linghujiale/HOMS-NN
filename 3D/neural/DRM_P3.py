...
def main():
    ...
    model_N1.load_state_dict(torch.load('model_N3.mdl'))
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze((beta - b0) * w)
    ...
    torch.save(model.state_dict(), 'model_P3.mdl')
