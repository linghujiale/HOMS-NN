...
def main():
    ...
    data = pd.read_csv(r"data\w111.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    C01111 = torch.mean(C1 + C1 * u_x + C2 * v_y + C2 * w_z)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs + 1):
        ...
        loss_r2 = torch.squeeze((C1 - C01111) * u)
    ...
    torch.save(model.state_dict(), 'model_uvw111.mdl')
