...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\3d\data\N31.csv")
    data = np.array(data)
    data = data[0, 0:27000]
    ...
    for epoch in range(epochs + 1):
        ...
        loss_2 = torch.squeeze((low_z * output_r - output_low * u_z) * thermal)
        ...
        if epoch > int(3 * epochs / 5):
            if torch.abs(loss) < best_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), 'model_N31.mdl')
