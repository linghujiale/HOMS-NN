...
def main():
    ...
    data = pd.read_csv(r"data\N11.csv")
    data = np.array(data)
    data = data[0, 0:10000]
    ...
    a0 = torch.mean(thermal + thermal * u_x)
    print("a0: ", a0)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.mean(torch.squeeze((thermalxr * N1_x + thermalxr - a0) * output_r))
        loss_r3 = torch.mean(torch.squeeze(thermalxr * output_N1_r * N11_x))
    ...
    torch.save(model.state_dict(), 'model_N11.mdl')
