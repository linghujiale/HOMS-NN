...
def main():
    ...
    data = pd.read_csv(r"data\u111.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"data\v111.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    C01111 = torch.mean(C1111 + C1111 * u_x + C1122 * v_y)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze((C1111 - C01111) * u)
    ...
    torch.save(model.state_dict(), 'model_uv111.mdl')
