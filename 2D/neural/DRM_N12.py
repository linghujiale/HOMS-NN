...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\N12.csv")
    data = np.array(data)
    data = data[0, 0:10000]
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.mean(torch.squeeze((thermalxr * N1_x) * output_r))
    ...
    torch.save(model.state_dict(), 'model_N12.mdl')
