...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\u212.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\v212.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    model_uv.load_state_dict(torch.load('model_uv12.mdl'))
    ...
    C01111 = torch.mean(C1212 + C1212 * u_y + C1212 * v_x)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze((C1212 - C01111) * u)
    ...
    torch.save(model.state_dict(), 'model_uv212.mdl')
