...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\u22.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\v22.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze(C1122 * u_x) + torch.squeeze(C1111 * v_y)
    ...
    torch.save(model.state_dict(), 'model_uv22.mdl')
