...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\ub2.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\vb2.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    beta11 = torch.mean(beta + C1122 * u_x + C1111 * v_y)
    print("beta11: ", beta11)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze((lu_y + lv_x) * C1212 * u)
        loss_r3 = torch.squeeze((beta - beta11) * v)
        loss_r4 = torch.squeeze((C1122 * lu_x + C1111 * lv_y) * v)
        loss_r5 = torch.squeeze(C1122 * u_x * lv + C1212 * u_y * lu)
        loss_r6 = torch.squeeze(C1212 * v_x * lu + C1111 * v_y * lv)
