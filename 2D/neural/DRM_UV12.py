...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\u12.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\v12.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze(C1212 * u_y) + torch.squeeze(C1212 * v_x)
    ...
    torch.save(model.state_dict(), 'model_uv12.mdl')
