...
def main():
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\u222.csv")
    data = np.array(data)
    data = data[0,0:10000]
    ...
    data = pd.read_csv(r"E:\pycharm\project6\2d\data\v222.csv")
    data = np.array(data)
    data = data[0,0:10000]
    data = data.reshape(100, 100)
    ...
    C01111 = torch.mean(C1111 + C1122 * u_x + C1111 * v_y)
    print("C01111: ", C01111)
    ...
    for epoch in range(epochs+1):
        ...
        loss_r2 = torch.squeeze((C1111 - C01111) * v)
    ...
    torch.save(model.state_dict(), 'model_uv222.mdl')
